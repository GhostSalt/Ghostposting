return {
        ...
        Joker = {
            ...
            j_gstpst_greenmatador          = {
                ...
                text =
                {
                    ...
                    "gains {C:money}+$#2#{} for each {C:red}discard{}",
                    "remaining after defeating",
            ...
            j_gstpst_bluematador           = {
                ...
                {
                    "Earn {C:money}$#1#{} at end of round,",
                    "gains {C:money}+$#2#{} for each {C:blue}hand{}",
                    "remaining after defeating",
                    "each {C:attention}Boss Blind{}"
                }
            },
            ...
            j_gstpst_cacklejack            = {
                ...
                text =
                {
                    "At the end of the round, replaces",
                    "a random {C:attention}Joker{} to the right",
                    "with another of the same {C:attention}rarity{}",
            ...
            j_gstpst_onearmedbandit        = {
                ...
                {
                    {
                        "Press {C:red}SPIN{} to pay {C:money}$#1#{}",
                        "and crank the handle!",
                        "{C:inactive}(House edge: 1.62%){}"
                    },
                    {
                        "Flushes pay {C:money}$#2#{}: 3 {C:red}red{} or black suits",
                        "Lines pay {C:money}$#3#{}: 3 of a kind",
                        "Jackpots pay {C:money}$#4#{}: 3 {C:attention}7{}s",
                        "{C:attention}WILD Cards{} count as",
                        "all symbols except {C:attention}7{}s"
                    },
                    {
                        "{C:red}Bonus Reel{}: On payout, earn",
                        "a bonus {C:money}$#5#{} if the {C:red}Bonus{}",
                        "{C:red}Reel{} matches {C:attention}Reel 3{}",
    ...
    misc = {
        dictionary = {
            ...
            b_boris_rank                = "Rank",
            k_gstpst_unknown            = "Unknown",
            k_gstpst_active             = "active",
            k_gstpst_inactive           = "inactive",
